...
car_data = {
  ...
  'Ram': ('black', 2017, 1.6, 'pickup', 36000),
  'Chevy': ('red', 2017, 2.4, 'pickup', 35000),
  'Dodge Ram': ('white', 2020, 3.6, 'pickup', 45000),
  'Ford F-Series': ('gray', 2021, 3.5, 'pickup', 50000),
  'Nissan Titan': ('silver', 2017, 1.6, 'pickup', 36000)
}
search_criteria =(2017, 1.6, 36000)
set_criteria = set(search_criteria)
#print(set_criteria)

for key, val in car_data.items():
  list_values = set(val)
  #print(list_values)
  set_searched = list_values.intersection(set_criteria)
  if len(set_searched) ==3 :
    print(f"{key} has matched criteria with search")
    print(set_searched)